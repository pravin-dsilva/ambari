...
Em.I18n.translations = {
  ...
  'installer.step3.hostWarningsPopup.jdk.name.empty': 'JDK not found for OS type <i>{0}</i>',
  ...
  'ambari.repository.url.os.textbox':'Please enter valid Ambari Repository URLs for the below OS types',
  ...
  'installer.step3.javaHome.validation.error':'Please enter a valid Java home path',
  'installer.step3.javaHome.property.error':'Java home property could not be found for one or more OS. Please enter a valid Java home path and try again',
